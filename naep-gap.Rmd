...
## TODO
## o try one of the MetBrewer color palettes
## o 
...
D0a <- read_xls(here("data", "NDECoreExcel_Reading-Grade4-Raceethnicity-used-to-report-tr_20220208182109.Xls"),
...
D0b <- read_xls(here("data", "NDECoreExcel_Reading, Grade 4, All students - 2_20220208181010.Xls"),
...
## subgroups: Title 1
D0c <- read_xls(here("data", "NDECoreExcel_Reading, Grade 4, Receive Title I funding_20220211224354.Xls"),
...
Figure shows average NAEP 4th grade reading scores by state, including District of Columbia (DC) and Dept. of Defence Educational Authority (DoDEA). 
  ...
  * Connecticut is highlighted in yellow. National average is in red.
...
p2 <-
    ...
    geom_point(size=2) +
    scale_color_manual(values=rev(met.brewer("VanGogh2", 2))) +
    scale_alpha_manual(values=c(A = 1, B = 1, C = 1/4)) +
    theme_minimal() +
    theme(axis.text.x = element_text(angle=90, hjust=1, vjust=.4)) +
    labs(title="Gap in NAEP 4th Grade Reading Scores by State (2019)") +
    ylab ("Average 4th Grade Reading Scores") +
    xlab ("")
...
p3 <-
    ...
    theme_minimal() +
    ## theme(axis.text.x = element_text(angle=90, hjust=1, vjust=.4)) +
    labs(title="Gap in CT 4th Grade Reading Scores by Year") +
    ylab ("Average 4th Grade Reading Scores") +
    xlab ("")
...
David Braze, Ph.D., is a researcher and consultant with a background in linguistics and reading research. He has more than 25 years experience investigating the cognitive foundations of language, literacy, and educational achievement, including 17 years as a Senior Research Scientist at [Haskins Laboratories](https://haskinslabs.org/). His research at Haskins, funded by the National Institutes of Health, emphasized the neurobiology of language and reading and applications to education. Dr. Braze consults widely for business, government, and non-profit sectors. 
...
All data summaries in this dashboard were carried out using the _R_ statistical environment, version `r paste(version$major, version$minor, sep=".")` [@cite_R]. The dashboard itself was produced using an Rmarkdown workflow. The following table lists the non-base R packages used in building the report. To see a full citation for a specific package, assuming you have both _R_ and the particular package installed, call (e.g.) _citation(dplyr)_ from the _R_ prompt. 
